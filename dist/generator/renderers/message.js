...
async function renderMessage(message, context) {
    ...
    return (react_1.default.createElement(discord_components_react_1.DiscordMessage, { id: `m-${message.id}`, timestamp: message.createdAt.toISOString(), key: message.id, edited: message.editedAt !== null, server: isCrosspost !== null && isCrosspost !== void 0 ? isCrosspost : undefined, highlight: message.mentions.everyone, profile: message.author.id },
        ...
        message.hasThread && message.thread && (react_1.default.createElement(discord_components_react_1.DiscordThread, { slot: "thread", name: message.thread.name, cta: message.thread.messageCount
                ? `${message.thread.messageCount} ${message.thread.messageCount > 1 ? await ((_c = (_b = message.guild) === null || _b === void 0 ? void 0 : _b.translate) === null || _c === void 0 ? void 0 : _c.call(_b, "tickets/words:MESSAGE_2")) : (_f = await ((_e = (_d = message.guild) === null || _d === void 0 ? void 0 : _d.translate) === null || _e === void 0 ? void 0 : _e.call(_d, "tickets/words:MESSAGE_1"))) !== null && _f !== void 0 ? _f : `Message${message.thread.messageCount > 1 ? 's' : ''}`}`
                : `${(_j = (_h = (_g = message.guild) === null || _g === void 0 ? void 0 : _g.translate) === null || _h === void 0 ? void 0 : _h.call(_g, "tickets/attachments:SEE_THREAD")) !== null && _j !== void 0 ? _j : 'View Thread'}` }, message.thread.lastMessage ? (react_1.default.createElement(discord_components_react_1.DiscordThreadMessage, { profile: message.thread.lastMessage.author.id }, await (0, content_1.default)(message.thread.lastMessage.content.length > 128
            ? message.thread.lastMessage.content.substring(0, 125) + '...'
            : message.thread.lastMessage.content, Object.assign(Object.assign({}, context), { type: content_1.RenderType.REPLY })))) : (`${(_m = (_l = (_k = message.guild) === null || _k === void 0 ? void 0 : _k.translate) === null || _l === void 0 ? void 0 : _l.call(_k, "tickets/attachments:MESSAGES_NOT_SAVED")) !== null && _m !== void 0 ? _m : 'Thread messages not saved.'}`)))));
}
